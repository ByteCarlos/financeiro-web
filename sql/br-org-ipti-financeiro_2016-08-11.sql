...
CREATE TABLE `fornecedor` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `forn_unique` (`cnpj`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

TRUNCATE `fornecedor`;
INSERT INTO `fornecedor` (`id`, `nome`, `cnpj`) VALUES
(1,	'Saulo Faria Almeida Barreto',	NULL),
(2,	'Fábio Henrique dos Santos',	NULL),
(3,	'IPTI',	NULL),
(4,	'Rafael de Oliveira Teles',	NULL),
(5,	'Renata Piazzalunga',	NULL),
(6,	'Fábio Theoto Rocha',	NULL),
(7,	'Marília Gonçalves da Rocha',	NULL),
(8,	'Wallison Hipólito de Meira',	NULL),
(9,	'Ana Letícia Carvalho',	NULL),
(10,	'Francisco Mota Cabral Filho',	NULL),
(11,	'Bruno Alves Reis Nascimento',	NULL),
(12,	'Ítalo Rafael de Almeida Pedral',	NULL),
(13,	'Saulo Faria Almeida Barreto EPP',	NULL),
(14,	'Silveira & Figueiredo Viagens e Turismo Ltda',	'03.140.579.0003-48'),
(15,	'Porto Seguro Cia de Seguros Gerais',	'61.198.164/0001-60'),
(16,	'Celera Tecnologia em Equipamentos Médicos Ltda ME',	'08.477.694/0001-64'),
(17,	'Ministério da Fazenda',	'00.394.460/0058-87'),
(18,	'Ministério da Previdência',	'00.394.528/0001-92'),
(19,	'Município de Santa Luzia do Itanhy',	'13.098.942/0001-04');
