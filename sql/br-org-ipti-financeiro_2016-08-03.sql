...
(4,	'Design',	1),
(5,	'Tarifa',	NULL),
(6,	'Despesas Administrativas',	NULL);
...
(4,	'2016-07-06',	'despesa teste 2',	3,	1,	3,	3000,	'ènois',	1),
(5,	'2016-07-07',	'despesa gasosa',	2,	3,	2,	100,	NULL,	NULL);
...
(39,	'2016-08-04',	'Receita 3',	2,	3,	1,	70,	'mama mia',	123);
...
CREATE TABLE `rubrica` (
  ...
  CONSTRAINT `rubrica_ibfk_2` FOREIGN KEY (`categoria_fk`) REFERENCES `categoria` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(1,	2,	3,	1,	'Programador Java ',	'Produto',	12,	1,	1,	3000,	1.2,	43200,	3),
(2,	4,	5,	1,	'Design Front-End',	'Produto',	12,	1,	1,	3000,	1,	36000,	3),
(3,	3,	NULL,	1,	'Combustível para viagem à carro',	'Mês',	12,	1,	0,	1500,	1,	18000,	NULL),
(4,	3,	NULL,	2,	'Combustível para viagem à carro',	'Mês',	3,	1,	0,	1500,	1,	4500,	NULL);
