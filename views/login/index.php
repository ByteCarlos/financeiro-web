...
<div class="container">
    <div class="row">
        <div class="main">
            <img class="ipti-logo" src="/common/img/logo.gif"/>
            <div class="login-panel panel panel-default <?= $action != "recover" ? "" : "display-hide" ?>">
                    ...
                    <form id="login-form" role="form" method="post">
                        ...
                        <fieldset>
                            ...
                            <div class="form-actions">
                                <div class="checkbox">
                                    <label>
                                        <input name="persistent" type="checkbox" value="1">Lembrar-me
                                    </label>
                                </div>
                                <span class="separator">·</span>
                                Esqueceu sua senha? <a href="javascript:;" id="forget-password">Clique aqui.</a>
                                <button class="btn pull-right btn-default login">Login</button>
                            </div>
                        </fieldset>
                    </form>
                </div>
